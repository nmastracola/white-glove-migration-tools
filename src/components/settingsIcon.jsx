...
class SelectedIcon extends React.Component {
  ...
  render() {
    ...
    return <SettingsIcon className={location.pathname === "/settings" ? "selected" : "icon"} />;
  }
}

const SelectedIconWithRouter =  withRouter(SelectedIcon)

export default SelectedIconWithRouter